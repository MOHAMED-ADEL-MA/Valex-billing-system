							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12  " id="notifications_count">اشعارات غير مقروءه : {{ auth()->user()->unreadNotifications->count() }}</p>
									</div>
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">
										@foreach (auth()->user()->unreadNotifications as $notification )
											
										<a class="d-flex p-3 border-bottom" href="{{ route('invoiceDetails',$notification->data['id']) }}">
