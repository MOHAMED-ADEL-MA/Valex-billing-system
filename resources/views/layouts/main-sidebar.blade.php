...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        ...
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/dashboard') }}"><img
        ...
        <ul class="side-menu">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ url('/invoices') }}">قائمه الفواتير</a></li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/invoices_paid') }}">الفواتير المدفوعه</a></li>
                        @endcan

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/invoices_unpaid') }}">الفواتير الغير مدفوعه</a></li>
                        @endcan

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/invoices_Partial') }}">الفواتير المدفوعه جزئيا</a></li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/archive') }}">الفواتير المؤرشفه </a></li>
                        @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('customer_report') }}">تقارير العملاء</a></li>
                        @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ url('users') }}">قائمه المستخدمين</a></li>
                        @endcan
